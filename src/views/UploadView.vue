    ...
    <section class="upload-section">
      <div class="container upload-card">
        ...
        <p class="upload-description">
          Apenas ficheiros PDF, DOCX, XLSX e PPTX são permitidos. Tamanho
          máximo: 10MB.
        </p>
        ...
        <form class="upload-form" @submit.prevent="handleUpload">
          ...
          >
            <span v-if="!isUploading">
              ...
              >
                <path
                  d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-16.5-9L12 3m0 0l-7.5 7.5M12 3v13.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
              </svg>
...
const onFileSelected = (event) => {
  ...
  if (file) {
    ...
    if (!allowedTypes.includes(file.type)) {
      statusMessage.value =
        "Tipo de ficheiro não permitido. Apenas PDF, DOCX, XLSX, PPTX.";
...
.upload-section {
  ...
  min-height: calc(
    100vh - 75px - 200px - 80px
  ); /* Ajusta para ocupar espaço mínimo */
}
